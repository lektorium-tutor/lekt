...
There's a lot more to Lekt than that! To learn more about what you can do with Lekt and Open edX, check out the :ref:`whatnext` section. If the quickstart installation method above somehow didn't work for you, check out the :ref:`troubleshooting` guide.
