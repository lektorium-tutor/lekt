...
- [Bugfix] Fix missing tables on migration from maple ([#689](https://github.com/lektorium-tutor/tutor/issues/689)). (by @ibrmora)
...
- [Security] Apply rate limiting security fix (see [commit](https://github.com/lektorium-tutor/edx-platform/commit/b5723e416e628cac4fa84392ca13e1b72817674f)). (by @regisb)
...
- [Security] Fix vulnerability in redirect URL during authentication (see [commit](https://github.com/lektorium-tutor/edx-platform/commit/06550411e34c04376fa3d757e1f068f464f816e6)).
...
- 💥[Improvement] Move the Open edX forum to a [dedicated plugin](https://github.com/lektorium-tutor/tutor-forum/) (#450).
...
- [Feature] Add [tutor-richie](https://github.com/lektorium-tutor/tutor-richie) to the plugins that are bundled with the tutor binary.
...
- [Bugfix] Fix "Invalid type for parameter ContentType" error on js upload in Scorm xblock ([openedx-scorm-xblock #16](https://github.com/lektorium-tutor/openedx-scorm-xblock/issues/16)).
