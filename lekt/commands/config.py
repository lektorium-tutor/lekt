...
from .. import config as lekt_config
...
@click.group(
    ...
    help="""Configure Open edX and store configuration values in $LEKT_ROOT/config.yml""",
)
...
def save(
    ...
    config = lekt_config.load_full(context.root)
