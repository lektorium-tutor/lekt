...
from lekt import exceptions, fmt, hooks, utils
from lekt.__about__ import __app__, __version__
from lekt.commands.config import config_command
from lekt.commands.context import Context
from lekt.commands.dev import dev
from lekt.commands.images import images_command
from lekt.commands.k8s import k8s
from lekt.commands.local import local
from lekt.commands.plugins import plugins_command
...
class LektCli(click.MultiCommand):
    """
    ...
    def get_command(
        ...
        """
        This is run when passing a command from the CLI. E.g: lekt config ...
        """
...
@click.group(
    ...
    help="Lekt is the Docker-based Open edX distribution designed for peace of mind.",
)
