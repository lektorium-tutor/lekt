...
def upgrade_from_lilac(config: Config) -> None:
    if not plugins.is_installed("forum"):
        fmt.echo_alert(
            ...
            "you must install and enable the lekt-forum plugin: https://github.com/lektorium-tutor/lekt-forum"
        )
        ...
        fmt.echo_info(
            ...
            "plugin with: `lekt plugins disable forum`."
        )
        plugins.load("forum")
    ...
    if not plugins.is_installed("mfe"):
        ...
        fmt.echo_info(
            ...
            "plugin with: `lekt plugins disable mfe`."
        )
        plugins.load("mfe")
        lekt_config.save_enabled_plugins(config)
